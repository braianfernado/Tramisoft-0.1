...
function onSelectnacionalidad(){
    ...
    if(nacionalidad_id){
        ...
        $.get('/superuser/ciudad/editar/departamentos/'+nacionalidad_id+'' , function (data) {       
...
function onSelectCiudad(){
    ...
    if(departamento_id){
      ...
      $.get('/superuser/comuna/editar/ciudades/'+departamento_id+'' , function (data) {       
...
function onSelectComuna(){
    ...
    if(ciudad_id){
      ...
      $.get('/superuser/barrio/editar/comunas/'+ciudad_id+'' , function (data) {       
...
function onSelectBarrio(){
    ...
    if(comuna_id){
      ...
      $.get('/superuser/solicitantes/editar/barrio/'+comuna_id+'' , function (data) {       
