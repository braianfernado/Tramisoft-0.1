...
<div class="row">
  ...
  <div class="column" >
   <p style="text-align: right;" ><a class="btn btn-outline-secondary"   href="{{ route('empleadojefe.empleadojefe-ver-Rechazados', $Tramite->id)}} "><i class="fas fa-eye"></i>Ver Tramite</a> </p>
  </div>
</div>
