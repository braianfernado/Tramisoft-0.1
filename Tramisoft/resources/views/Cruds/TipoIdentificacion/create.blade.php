...
<table class="table table-bordered" style="border: 0; margin:0px">
    <tr>
        <th style="border: 0;">
            <h2 class="titulo">Crear Tipo Identificacion</h2>
        </th>
...
<form action="{{ route('superuser.tipoidentificacion-validar') }}" method="POST">
    @csrf
     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nombreIdentificacion" class="form-control" placeholder="Nombre Tipo Identificacion" required>
            </div>
        </div>
