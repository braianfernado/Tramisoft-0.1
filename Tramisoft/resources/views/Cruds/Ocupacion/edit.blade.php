...
<table class="table table-bordered" style="border: 0; margin:0px">
    <tr>
        <th style="border: 0;">
            <h2 class="titulo">Editar Ocupacion</h2>
        </th>
...
<form action="{{ route('superuser.ocupacion-actualizar', $Ocupacion->id) }}" method="POST">
    @csrf
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="nombreOcupacion" value="{{ $Ocupacion->nombreOcupacion }}" class="form-control" placeholder="Nombre" required>
            </div>
        </div>
