...
<table class="table table-bordered" style="border: 0; margin:0px">
    <tr>
        <th style="border: 0;">
            <h2 class="titulo">Crear Comuna</h2>
        </th>
...
<form action="{{ route('superuser.comuna-validar') }}" method="POST">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <input type="text" name="nombre" class="form-control" placeholder="Nombre Comuna" required>
        </div>
    </div>
